...
class PossessionsRepository extends ServiceEntityRepository
{
    ...
    public function add(Possessions $entity, bool $flush = false): void
    {
    ...
    /**
     * @return Possessions[] Returns an array of Possession objects
     */
    public function getPossessions($id): array
    {
        return $this->createQueryBuilder('p')
//            ->join('App\Entity\User', 'user', Join::ON, 'user.id = user_id')
